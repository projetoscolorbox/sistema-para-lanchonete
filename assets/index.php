...
<body>
		...
		//carregando as informações padrão

		if(isset($_SESSION['nome'])){
			echo "Bem vindo ao ".$config->getEmpresa()." ".$_SESSION['nome']."<br>";
		}

		//$botao_ativo = ($_GET['acao'] = "") ? "botao-atencao" : "botao-urgente";

		echo "<a class='botao botao-atencao' href='?acao=Cardapio'>Cardápio</a>";
		...
		if ( isset($_SESSION['usuario']) && !empty($_SESSION['usuario'])) {
			...
			echo "<a class='botao botao-atencao' href='modules/?acao=Logar'>Login</a>";
